...
const typeLabels = { ebook: 'E-book em PDF', caneca: 'Caneca', camiseta: 'Camiseta', blusao: 'Blusão', assinatura: 'Assinatura', consultoria: 'Consultoria', outro: 'Outro' }
